  ...
  return (
    <div className="">
     ...
     <div className="mb-8">
      ...
      <p className="text-lg text-black dark:text-white"> Hop to the <span className="text-purple-500 font-semibold"><Link href="../members/portal">member portal</Link></span> for current opportunities.</p>
      </div>
