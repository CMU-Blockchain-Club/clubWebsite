    ...
    <div className="">
      <main className="">
        <div className="min-h-[100vh] mx-auto dark:bg-black dark:text-white">
          <div className="h-[15vh] md:h-[16vh] lg:h-[20vh] xl:h-[25vh]"></div>
            ...
            <div className="flex-col md:flex-row">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 mx-auto gap-4 md:gap-8 px-8 md:px-0">
                <DoCard
                  title={"101"}
                  description={
                    "Senior members deliver weekly education sessions that simplify the complex world of blockchain."
                  }
                  hexColor={CMUBrand.green}
                />

                <DoCard
                  title={"Labs"}
                  description={
                    "An incubator for CMU students to transform ideas into code that changes the world. Project teams are supported by community grants and in house advisors."
                  }
                  hexColor={CMUBrand.red}
                />

                <DoCard
                  title={"Network"}
                  description={
                    "We connect the best blockchain companies with the brightest minds from Carnegie Mellon."
                  }
                  hexColor={CMUBrand.blue}
                />
              </div>
            </div>
          </div>
            ...
            <div className="flex-col md:flex-row">
              ...
              <div className="grid grid-cols-1  mx-auto place-items-center">
                {FacultyAdvisors.length != 0 &&
                  FacultyAdvisors.map(
                    (facultyAdvisor: IAdvisor, index: number) => (
